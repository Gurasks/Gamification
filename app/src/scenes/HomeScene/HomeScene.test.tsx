...
describe('HomeScene', () => {
  ...
  describe('Loading behavior', () => {
    ...
    it('should show LoadingOverlay initially and then display content', async () => {
      ...
      expect(screen.getByText(/Bem vindo Test User ao Singular!/)).toBeInTheDocument();
    });
  ...
  describe('Main content', () => {
    it('should render content when user is authenticated with valid name', async () => {
      ...
      expect(screen.getByText('Bem vindo João Silva ao Singular!')).toBeInTheDocument();
    ...
    it('should display user name correctly in the title', async () => {
      ...
      expect(screen.getByText('Bem vindo Maria Santos ao Singular!')).toBeInTheDocument();
    });
  });
  ...
  describe('Special cases', () => {
    ...
    it('should allow user with 2-character displayName', async () => {
      ...
      expect(screen.getByText('Bem vindo Jo ao Singular!')).toBeInTheDocument();
